  ...
  <Dropdown.Menu>
    ...
    <Dropdown.Item href="#/action-3">Logout</Dropdown.Item>
      ...
      >
        ...
        <Divider />
        <List>
          {[{value: 'Dashboard', link:"/"}, {value: 'Add Products', link:"/"}, {value: 'Add  Blog', link:"/add-blog"}, {value: 'Add News', link:"/add-news"}, {value: 'New Menu', link:"/"}, {value: 'New User', link:"/"},{value: 'Profile', link:"/"}].map((text, index) => (
